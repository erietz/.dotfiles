...
keymap.nnoremap('<leader>fc', function()
    ...
    { desc = "Telescope: find git commits for current repo" }
)

keymap.nnoremap('<leader>fb', function()
    require('telescope.builtin').git_bcommits()
end,
    { desc = "Telescope: find git commits for current buffer" }
)

keymap.nnoremap('<leader>fi', function()
    require('telescope.builtin').builtin()
end,
    { desc = "Telescope: search telescope built in functions" }
)

keymap.nnoremap('<leader>fk', function()
    require('telescope.builtin').keymaps()
end,
    { desc = "Telescope: search normal mode key mappings" }
)
