...
-- use /usr/share/awesome/themes instead of modified ~/.config/awesome/themes
-- because there are a ton of images that I don't want in my dotfiles.
...
theme.awesome_icon = theme_assets.awesome_icon(theme.menu_height, theme.accent, theme.bg_normal)
