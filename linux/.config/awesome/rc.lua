...
-- Author      : Ethan Rietz
-- Date        : 2021-12-16
-- Description : Main config file for the Awesome Window Manager
--------------------------------------------------------------------------------
...
globalkeys = gears.table.join(
	...
	end, { description = "Set screen padding for ultrawide monitor", group = "client" }),
	...
	end, { description = "Reset screen padding back to zero", group = "client" }),
	...
	end, { description = "Toggle play/pause", group = "client" }),
	awful.key({}, "XF86AudioNext", function()
		awful.util.spawn("playerctl next")
	end, { description = "Next song", group = "client" }),
	awful.key({}, "XF86AudioPrev", function()
		awful.util.spawn("playerctl previous")
	end, { description = "Previous song", group = "client" }),
	...
	end, { description = "Mute audio", group = "client" }),
	awful.key({}, "XF86AudioMicMute", function()
		awful.util.spawn("pulseaudio-ctl mute-input")
	end, { description = "Mute Microphone", group = "client" })
)
